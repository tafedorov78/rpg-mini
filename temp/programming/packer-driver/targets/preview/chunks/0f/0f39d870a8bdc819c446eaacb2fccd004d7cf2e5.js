      ...
      _export("MainMenuScene", MainMenuScene = (_dec = ccclass('MainMenuScene'), _dec2 = property(Button), _dec3 = property({
        ...
        constructor() {
          ...
          this.levelIconsUpdate = team => {
            ...
            var score = this.calculateScore(totalHP);
            ...
            var icon = this.LevelsIconsContainer.getChildByName("LevelIcon" + (_crd && Facade === void 0 ? (_reportPossibleCrUseOfFacade({
              error: Error()
        ...
        loadGameProgress() {
          ...
          if ((_crd && Facade === void 0 ? (_reportPossibleCrUseOfFacade({
            ...
            (_crd && Facade === void 0 ? (_reportPossibleCrUseOfFacade({
              ...
              var icon = this.LevelsIconsContainer.getChildByName("LevelIcon" + level.id);
            ...
            for (var i = 0; i < this.LevelsIconsContainer.children.length; i++) {
              var level = {
                id: i,
                complete: false,
                score: (_crd && Score === void 0 ? (_reportPossibleCrUseOfScore({
        ...
        getEnemyTeam(heroesConfig, count) {
          var uniqueElements = Array.from(new Set(heroesConfig));

          for (var i = uniqueElements.length - 1; i > 0; i--) {
