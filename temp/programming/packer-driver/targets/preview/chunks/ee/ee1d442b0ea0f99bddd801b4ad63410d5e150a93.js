    ...
    execute: function () {
      ...
      _export("BattleComponent", BattleComponent = (_dec = ccclass('BattleComponent'), _dec2 = property({
        ...
        constructor() {
          ...
          this.onHP = team => {
            var total = this.getTotalTeamHP(team);
            var initial = team.id === 1 ? this.totalHP1 : this.totalHP2;
            var percentage = this.calculatePercentage(initial, total);
            var progressBarName = team.id === 1 ? 'GreenProgressBar' : 'RedProgressBar';
          ...
          this.calculatePercentage = (initialValue, currentValue) => {
            ...
            var percentage = currentValue / initialValue;
