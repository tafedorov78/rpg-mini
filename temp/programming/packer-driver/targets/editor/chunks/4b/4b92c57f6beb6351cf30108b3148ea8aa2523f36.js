      ...
      _export("HeroesTabComponent", HeroesTabComponent = (_dec = ccclass('HeroesTabComponent'), _dec2 = property({
        ...
        constructor(...args) {
          ...
          this.onCardChecked = id => {
            const heroConfig = this.heroesConfig.find(hero => hero.id === id);
        ...
        createCard(spriteFrame, data) {
          ...
          const heroCardComponent = card.getComponent(_crd && HeroCardComponent === void 0 ? (_reportPossibleCrUseOfHeroCardComponent({
            error: Error()
